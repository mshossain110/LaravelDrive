...
<!-- bootstrap-wysiwyg -->
    ...
    <script src="/bower/jquery.hotkeys/jquery.hotkeys.js" type="text/javascript"></script>
    <script src="/bower/google-code-prettify/src/prettify.js" type="text/javascript"></script>
    <!-- jQuery Tags Input -->
    <script src="/bower/jquery.tagsinput/src/jquery.tagsinput.js" type="text/javascript"></script>
    <!-- Switchery -->
    <script src="/bower/switchery/dist/switchery.min.js" type="text/javascript"></script>
    <!-- Select2 -->
    <script src="/bower/select2/dist/js/select2.full.min.js" type="text/javascript"></script>
    <!-- Parsley -->
    <script src="/bower/parsleyjs/dist/parsley.min.js" type="text/javascript"></script>
    <!-- Autosize -->
    <script src="/bower/autosize/dist/autosize.min.js" type="text/javascript"></script>
    <!-- jQuery autocomplete -->
    <script src="/bower/devbridge-autocomplete/dist/jquery.autocomplete.min.js" type="text/javascript"></script>
    <!-- starrr -->
    <script src="/bower/starrr/dist/starrr.js" type="text/javascript"></script>
